...
class e01_syntaxe extends HandsOnSuite {
  ...
  section("Astuces pratiques") {
    ...
    exercice("paramètres nommés et paramètre par défaut") {
      ...
      ref1 shouldBe "scala-class~problems~cd959defd71f36f822dbd741085696b508549763"
      ref2 shouldBe "scala-class~problems~cd959defd71f36f822dbd741085696b508549763"
    }
  }
}
